...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        onClick={router.back}
        className="btn-close sm:hidden block absolute px-4 py-6 left-0 top-0 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground z-50"
      >
